...
_EXPORTS: Final = MappingProxyType(
    {
        ...
        "RemovalBooking": ("absence", "RemovalBooking"),
        "RemovalPlan": ("absence", "RemovalPlan"),
        "Span": ("absence", "Span"),
        "Tally": ("absence", "Tally"),
        "ToilBalance": ("absence", "ToilBalance"),
        ...
        "plan_removal": ("absence", "plan_removal"),
        "snapshot_booking": ("absence", "snapshot_booking"),
        ...
        "RETRY_AFTER": ("bank_holidays", "RETRY_AFTER"),
        ...
        "INVALID_ENTITLEMENT": ("settings", "INVALID_ENTITLEMENT"),
        ...
        "parse_entitlement_days": ("settings", "parse_entitlement_days"),
        ...
        "validate_entitlement_days": ("settings", "validate_entitlement_days"),
